...
VideoFaceDetector::VideoFaceDetector(const std::string cascadeFilePath, VideoCapture &videoCapture)
{
...
Rect VideoFaceDetector::biggestFace(std::vector< Rect> &faces) const
{
	assert(!faces.empty());
